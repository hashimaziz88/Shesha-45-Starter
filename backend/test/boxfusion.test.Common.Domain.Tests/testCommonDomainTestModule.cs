...
using Moq;
using NSubstitute;
using boxfusion.test.Domain;
using boxfusion.test.Tests.DependencyInjection;
using Shesha;
...
namespace boxfusion.test.Common.Tests
{
    [DependsOn(
        typeof(testModule),
    ...
    public class testCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public testCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
